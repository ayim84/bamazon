        ...
        ).then(function(response)
        {
            ...
            connection.query("SELECT * FROM products WHERE ?",
                ...
                },function(err, response)
                {
                    ...
                    console.log("New Quantity 1: " + newQuantity);

                }
            );
            
            console.log("New Quantity 2: " + newQuantity);
            // Need to get newQuantity from above to be available to be used below. Async issue?  Connection query above isn't completing before connection query below is running.
